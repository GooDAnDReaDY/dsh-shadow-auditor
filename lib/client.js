...
`;
        ...
        React.createElement('div', { className: 'sa-section-card' },
          ...
          topFinding ? React.createElement('div', {
            style: {
              ...
              border: '1px solid ' + (audit.level === 'red' ? 'var(--dsw-alias-color-danger, #ef4444)' : 'var(--dsw-alias-color-warning, #f59e0b)')
            }
          },
            ...
            topFinding.remediation ? React.createElement('div', {
              style: { fontSize: '11px', color: 'var(--dsw-alias-state-brand-primary, #3b82f6)', marginTop: '4px', fontWeight: 500 }
          ...
          events.length > 0 ? React.createElement('div', {
            ...
            events.map((ev, i) => {
              ...
              return React.createElement('div', {
                ...
                ev.blockedByGuard ? React.createElement('div', { style: { fontSize: '11px', color: 'var(--dsw-alias-color-danger, #ef4444)', marginTop: '4px' } },
                  ev.blockedByGuard
                ) : null,
    ...
    module.exports.apply = function apply(ctx) {
      try {
        ...
        ctx.logger?.debug?.('[shadow-auditor] UI locale registration failed (error type: ' + (err?.name || 'Error') + ').');
      }
