...
function PluginCard({ ctx }) {
      ...
      const onSave = async () => {
        ...
        try {
          ...
          const errors = [];
          for (const key of ['strictSecretScanning', 'blockDangerousCommands', 'enableAuditBadge', 'enableAuditLog', 'maxFileSizeMb', 'retentionDays', 'diffGateMode', 'enableSastScan', 'enablePromptInjectionScan']) {
            try {
      ...
      return React.createElement('div', { className: 'sa-card' },
        ...
        expanded ? React.createElement('div', { className: 'sa-body' },
          ...
          snap.status !== 'loading' ? React.createElement('div', null,
            ...
            React.createElement('div', { className: 'sa-field' },
              React.createElement('label', { className: 'sa-row' },
                React.createElement('span', null, t('diffGateMode') || 'Code-Security Diff Gate Mode'),
                React.createElement('select', {
                  ...
                  React.createElement('option', { value: 'warning' }, 'Warning (Audit)'),
                  React.createElement('option', { value: 'block' }, 'Block (Approval)')
                )
              ),
              React.createElement('div', { className: 'sa-sub' }, t('diffGateModeDesc') || 'Diff/approval boundary gate policy: warning or block on high/critical findings')
            ),
            React.createElement('div', { className: 'sa-field' },
              React.createElement('label', { className: 'sa-row' },
                React.createElement('span', null, t('enableSast') || 'Insecure code patterns (SAST)'),
                React.createElement('input', {
                  type: 'checkbox',
                  disabled: !isReady || saving,
              ...
              React.createElement('div', { className: 'sa-sub' }, t('enableSastDesc') || 'Detect SQL injection, command injection, path traversal, eval')
            ),
            React.createElement('div', { className: 'sa-field' },
              React.createElement('label', { className: 'sa-row' },
                React.createElement('span', null, t('enablePromptInjection') || 'Prompt-injection detection'),
                React.createElement('input', {
                  type: 'checkbox',
                  disabled: !isReady || saving,
              ...
              React.createElement('div', { className: 'sa-sub' }, t('enablePromptInjectionDesc') || 'Detect instruction overrides and prompt exfiltration in diffs')
            ),
            React.createElement('div', { className: 'sa-field' },
              React.createElement('label', { className: 'sa-row' },
